@include('sidebar')
        ...
        <div align="center">
                ...
                <select name="question_type" id="question_type">
                    @foreach($questype as $question_type)
                        @if ($question_type->gamemode_id == $currQuiz->gamemode_id || $currQuiz->gamemode_id == 3)
                            @if ($question_type->type_id == $currQuiz->type_id)
            ...
            <form method="POST "action="{{route('add-multi-choice')}}">
                <input type="text" class="question_title" id="question_title" name="question_title" placeholder="Question Title" size="100"><br><br>
                ...
                <div align="center">
                    <button type="submit" class="btn btn-primary" value="previous">
